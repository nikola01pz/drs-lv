...
Peripheral Summary:
  ...
  logical library name                       : myaddsub_ip_v1_00_a
  top name                                   : myaddsub_ip
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/myaddsub_ip_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/myaddsub_ip_v2_1_0.tcl
