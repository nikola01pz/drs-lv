/*****************************************************************************
* Filename:          D:\DRS\LV2_Milicevic_Istvanic\EDK/drivers/myled_ip_v1_00_a/src/myled_ip_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the myled_ip driver
...
XStatus MYLED_IP_SelfTest(void * baseaddr_p)
{
  ...
  MYLED_IP_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = MYLED_IP_mReadSlaveReg0(baseaddr, 0);
