...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = myled_ip
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = myled
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = mydataseparator_ip
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = mydataseparator
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = myaddsub_ip
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = myaddsub
END
