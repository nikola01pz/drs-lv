	...
	print("Receiving data from keyboard:\r\n");
		while(1){
			...
			if (Status != XST_SUCCESS){
				...
				u32 color[] = {GREEN_COLOR, RED_COLOR, YELLOW_COLOR, BLUE_COLOR};
				int counter = 0;
				...
				{
					XTft_ClearScreen(&TftInstance);
					DrawHLine(170, 60, color[counter], 300);
				}
				if(RxBuffer == 0x1E)
				{
					XTft_ClearScreen(&TftInstance);
					DrawHLine(170, 50, color[counter], 300);
					DrawHLine(170, 70, color[counter], 300);
				}
				if(RxBuffer == 0x26)
				{
					XTft_ClearScreen(&TftInstance);
					DrawHLine(170, 40, color[counter], 300);
					DrawHLine(170, 60, color[counter], 300);
					DrawHLine(170, 80, color[counter], 300);
				}
				if(RxBuffer == 0x25)
				{
					XTft_ClearScreen(&TftInstance);
					DrawHLine(170, 30, color[counter], 300);
					DrawHLine(170, 50, color[counter], 300);
					DrawHLine(170, 70, color[counter], 300);
					DrawHLine(170, 90, color[counter], 300);
				}
